<?php 
    // we proceed on a double verification, 1 if the user is connected and 2 if the user is the owner of the whisp
    // and only in this case we allow the user to delete the whisp
    if (isset($_SESSION['s_users_id']) && $element['user_id'] == $_SESSION['s_users_id']) { ?>
